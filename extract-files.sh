...
function blob_fixup() {
    case "${1}" in
        vendor/bin/rmt_storage|vendor/bin/rmt_storage_global)
        ...
        vendor/lib/libmmcamera2_stats_modules.so)
            ...
            ;;
        vendor/lib/libchromaflash.so|vendor/lib/liboptizoom.so|vendor/lib/libmmcamera_hdr_gb_lib.so|vendor/lib/libts_detected_face_hal.so|vendor/lib/libts_face_beautify_hal.so|vendor/lib/libseemore.so|vendor/lib/libSonyIMX298PdafLibrary.so|vendor/lib/libtrueportrait.so|vendor/lib/libubifocus.so)
